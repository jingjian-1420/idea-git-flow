...
import cn.rieon.idea.git.flow.actions.GitflowPopupGroup;
...
public class GitflowWidget extends GitBranchWidget implements GitRepositoryChangeListener {
  ...
  public ListPopup getPopupStep() {
    ...
    ListPopup listPopup = new PopupFactoryImpl.ActionGroupPopup("Gitflow Actions",
        popupGroup.getActionGroup(), SimpleDataContext.getProjectContext(project), false, false,
        false, true, null, -1,
        null, null);
