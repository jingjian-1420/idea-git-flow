...
public class GitflowOptionsFactory {
  ...
  private GitflowOptionsFactory() {
    ...
    addOption(TYPE.FEATURE, "Do not fast-forward when merging, always create commit",
        "noFastForward", "--no-ff");
...
//        addOption(TYPE.RELEASE, "Squash release during merge", "squash" , "-S");
    ...
    addOption(TYPE.RELEASE, "Use custom tag commit message", "customTagCommitMessage", null,
        "Tagging version %name%", "Use %name% for the branch name");
    ...
    addOption(TYPE.HOTFIX, "Use custom hotfix commit message", "customHotfixCommitMessage", null,
        "Tagging hotfix %name%", "Use %name% for the branch name");
  }
  ...
  private void addOption(Enum<TYPE> branchType, String description, String key,
      @Nullable String flag) {
    addOption(branchType, description, key, flag, null, null);
  }

  private void addOption(Enum<TYPE> branchType, String description, String key,
      @Nullable String flag, @Nullable String inputText, @Nullable String toolTip) {
