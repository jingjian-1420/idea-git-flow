...
import cn.rieon.idea.git.flow.GitflowOptionsFactory;
...
public class GitflowOptionsForm implements ItemListener {
  ...
  public GitflowOptionsForm() {
    ...
    for (GitflowOptionsFactory.TYPE type : GitflowOptionsFactory.TYPE.values()) {
      ...
      for (Map<String, String> optionMap : gitflowOptions.get(type)) {
        ...
        optionComponents
            .put(GitflowOptionsFactory.getOptionId(type, optionMap.get("key")), optionComponent);
      }
    }
  }
  ...
  public void updateFormDisabledStatus() {
    ...
    JCheckBox customTagCommitMessageCheckbox = (JCheckBox) optionComponents
        .get("RELEASE_customTagCommitMessage").checkbox;
    JTextField customTagCommitMessageTexfield = (JTextField) optionComponents
        .get("RELEASE_customTagCommitMessage").textfield;

    JCheckBox dontTagHotfix = (JCheckBox) optionComponents.get("HOTFIX_dontTag").checkbox;
    JCheckBox customHotfixCommitMessageCheckbox = (JCheckBox) optionComponents
        .get("HOTFIX_customHotfixCommitMessage").checkbox;
    JTextField customHotfixCommitMessageTextfield = (JTextField) optionComponents
        .get("HOTFIX_customHotfixCommitMessage").textfield;
