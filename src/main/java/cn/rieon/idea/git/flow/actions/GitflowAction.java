...
import cn.rieon.idea.git.flow.Gitflow;
...
public class GitflowAction extends DumbAwareAction {
  ...
  public boolean handleMerge() {
    ...
    int answer = Messages
        .showYesNoDialog(myProject, "Was the merge completed succesfully?", "Merge",
    ...
    if (answer == 0) {
      ...
      NotifyUtil.notifyInfo(myProject, "Merge incomplete",
          "To manually complete the merge choose VCS > Git > Resolve Conflicts.\n" +
