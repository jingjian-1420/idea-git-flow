...
public class PublishReleaseAction extends GitflowAction {
  ...
  public void actionPerformed(AnActionEvent anActionEvent) {
    ...
    final String releaseName = GitflowConfigUtil
        .getReleaseNameFromBranch(myProject, myRepo, currentBranchName);
    ...
    new Task.Backgroundable(myProject, "Publishing release " + releaseName, false) {
      ...
      public void run(@NotNull ProgressIndicator indicator) {
        ...
        if (result.success()) {
          String publishedReleaseMessage = String
              .format("A new remote branch '%s%s' was created", releasePrefix, releaseName);
