...
public class FinishFeatureAction extends GitflowAction {
  ...
  public void runAction(final Project project, final String featureName) {
    ...
    final String baseBranch = GitflowConfigUtil
        .getBaseBranch(project, myRepo, featurePrefix + featureName);
      ...
      public void onSuccess() {
        ...
        if (errorLineHandler.hasMergeError) {
          if (handleMerge()) {
            ...
            FinishFeatureAction completeFinishFeatureAction = new FinishFeatureAction(myRepo,
                featureName);
          }
