...
public class StartReleaseAction extends GitflowAction {
  ...
  public void actionPerformed(AnActionEvent e) {
    ...
    final String releaseName = Messages
        .showInputDialog(myProject, "Enter the name of new release:", "New Release",
    ...
    if (releaseName == null) {
      ...
      new Task.Backgroundable(myProject, "Starting release " + releaseName, false) {
        ...
        public void run(@NotNull ProgressIndicator indicator) {
          ...
          if (result.success()) {
            String startedReleaseMessage = String
                .format("A new release '%s%s' was created, based on '%s'", releasePrefix,
                    releaseName, developBranch);
